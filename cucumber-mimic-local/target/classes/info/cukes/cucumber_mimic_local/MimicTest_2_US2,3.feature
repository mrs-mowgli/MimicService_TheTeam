...
And has learned request "Number" and response "Four"
And has learned request "Number" and response "Five"
And has learned request "Number" and response "Six"
When I give request "Number"
